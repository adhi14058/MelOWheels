...
<head>
	...
	<script src="https://kit.fontawesome.com/bdd1d2c718.js" crossorigin="anonymous"></script>
								...
								<form class="form-vertical " id="lifepackQuestionForm1" method="POST">
									...
									<div class="form-group">
										...
										<select class="form-control" id="exampleFormControlSelect1" name="option">
											...
											<option data-thumbnail="assets/img/fr.png" value="Matrix Questions">Matrix Questions</option>
											<option value="Mcq Questions">Mcq Questions</option>
											<option value="Image Type Question">Descriptive Text</option>
											<option value="Timer Question">Timer Type Question</option>
											<option value="Range Slider Question">Graphic Slider Question</option>
											<option value="Audio Type Question">Text Entry Question</option>
										</select>
