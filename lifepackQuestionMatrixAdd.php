						...
						<div class="row">
							<div class="container">
								<form class="form-vertical" id="lifepackQuestionForm" method="POST">
									...
									<div id="addStatement">
									<div class="form-group mb-4">
											<label class="control-label">Question Statement 1</label>
											<input type="text" name="qstatement1" id="qstatement1" class="form-control">
										</div>
										<div class="form-group mb-4">
											<label class="control-label">Question Statement 2 </label>
											<input type="text" name="qstatement2" id="qstatement2" class="form-control">
										</div>
									</div>
									...
									<div class="mt-4 float-right">
										<button type="submit" id="lpAddBtn" class="btn btn-primary ml-4">Add</button>
										<button class="btn btn-danger"><i class="flaticon-cancel-12"></i> Discard</button>
										<button type="submit" id="addOption" class="btn btn-success">Add Option</button>
										<button type="submit" id="sAddBtn" class="btn" style="background:#007BC0;color:#fff;">Add Statement</button>
